//THIS IS NOT A NORMAL OLED, BUT 5 PIN HEADER FOR NICE!nano OLED (Created by xpsking)
module.exports = {
    params: {
        designator: 'OLED',
        side: 'F',
    ...
    ${p.GND.str})
    (pad 0 thru_hole oval (at 1.6 12.34 ${p.rot+270}) (size 1.7 1.7) (drill 1) (layers *.Cu *.Mask)
    ${p.CS.str})
    )
    `
}